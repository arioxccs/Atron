...
namespace Atron
{
    public partial class FrmCadastrarProdutoGerente : Form
    {
        public FrmCadastrarProdutoGerente()
        {
            InitializeComponent();
        }

        private void FrmCadastrarProdutoGerente_Load(object sender, EventArgs e)
        {
