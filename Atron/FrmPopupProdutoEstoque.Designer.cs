namespace Atron
{
    partial class FrmPopupProdutoEstoque
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmPopupProdutoEstoque));
            panel1 = new Panel();
            lbl_PopUpNomeProduto = new Label();
            lbl_UltimaRespPop = new Label();
            lbl_CodFornecedorPop = new Label();
            lbl_MarcaPop = new Label();
            lbl_FornecedorPop = new Label();
            lbl_QtdeMinPop = new Label();
            lbl_QtdeTpop = new Label();
            lbl_CategoriaTPop = new Label();
            lbl_NomeProdutoTpop = new Label();
            lbl_CodProdutoTPop = new Label();
            pic_ProdutoPop = new PictureBox();
            btn_ReporEstoquePop = new Button();
            btn_CertoPop = new Button();
            lbl_CodProdutoRPop = new Label();
            lbl_MarcaRpop = new Label();
            lbl_NomeProdutoRPop = new Label();
            lbl_CategoriaRPop = new Label();
            lbl_QtdeRPop = new Label();
            lbl_QtdeMinRPop = new Label();
            lbl_CodFornecedorRpop = new Label();
            lbl_FornecedorRPop = new Label();
            lbl_UltimaRespRpop = new Label();
            ...
            pic_ProdutoPop.Location = new Point(667, 103);
            pic_ProdutoPop.Name = "pic_ProdutoPop";
            pic_ProdutoPop.Size = new Size(205, 217);
            pic_ProdutoPop.TabIndex = 11;
            pic_ProdutoPop.TabStop = false;
            // 
            // btn_ReporEstoquePop
            // 
            btn_ReporEstoquePop.BackColor = Color.FromArgb(14, 41, 184);
            btn_ReporEstoquePop.Font = new Font("Bebas Neue", 21.7499962F, FontStyle.Regular, GraphicsUnit.Point, 0);
            btn_ReporEstoquePop.ForeColor = Color.White;
            btn_ReporEstoquePop.Location = new Point(12, 556);
            btn_ReporEstoquePop.Name = "btn_ReporEstoquePop";
            btn_ReporEstoquePop.Size = new Size(275, 78);
            btn_ReporEstoquePop.TabIndex = 12;
            btn_ReporEstoquePop.Text = "Repor Estoque";
            btn_ReporEstoquePop.UseVisualStyleBackColor = false;
            // 
            // btn_CertoPop
            // 
            btn_CertoPop.BackColor = Color.FromArgb(14, 41, 184);
            btn_CertoPop.FlatAppearance.BorderSize = 0;
            btn_CertoPop.Image = (Image)resources.GetObject("btn_CertoPop.Image");
            btn_CertoPop.Location = new Point(774, 544);
            btn_CertoPop.Name = "btn_CertoPop";
            btn_CertoPop.Size = new Size(110, 110);
            btn_CertoPop.TabIndex = 13;
            btn_CertoPop.UseVisualStyleBackColor = false;
            btn_CertoPop.Click += btn_CertoPop_Click;
            // 
            // lbl_CodProdutoRPop
            // 
