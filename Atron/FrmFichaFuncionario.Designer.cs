namespace Atron
{
    partial class FrmFichaFuncionario
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            lbl_DataAdmissaoR = new Label();
            lbl_DataAdmissão = new Label();
            lbl_StatusR = new Label();
            lbl_StatusT = new Label();
            lbl_FuncaoR = new Label();
            ...
            pictureBox2.Location = new Point(781, 130);
        ...
        private Label lbl_FormaPagamentoR;
        private Label lbl_FormaPagamentoT;
        private Label lbl_SalarioR;
        private Label lbl_SalarioT;
        private Label lbl_DataAdmissaoR;
        private Label lbl_DataAdmissão;
        private Label lbl_StatusR;
        private Label lbl_StatusT;
        private Label lbl_FuncaoR;
